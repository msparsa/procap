#!/usr/bin/env python3
"""
Remote homology detection benchmark with linear probe evaluation.

Tests models: esm2_t6_8M, esm2_t33_650M, protbert
Uses 200 samples for quicker run.
"""
...
def main():
    ...
    output_path = Path("./mparsa/bench/procap-v2/benchmark_results/homology_results.json")
    num_samples = 200
    models_to_test = ["esm2_t6_8M", "esm2_t33_650M", "protbert"]

    print("=" * 80)
    print("Remote Homology Detection Benchmark - Linear Probe Evaluation")
    print("=" * 80)
