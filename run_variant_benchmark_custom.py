...
Evaluates protein language models on variant effect prediction using Ridge regression.
"""
...
def main():
    ...
    for model_name in model_names:
        ...
        try:
            ...
            runner = RegressionRunner(
                ...
                batch_size=16,
                show_progress=True,
                train_ratio=0.8  # 80% for training Ridge probe, 20% for testing
            )
    ...
    print(f"Linear probe: Ridge regression (train_ratio=0.8)")
