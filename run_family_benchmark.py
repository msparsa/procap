#!/usr/bin/env python3
"""
Protein family classification benchmark with linear probe evaluation.

Tests models: esm2_t6_8M, esm2_t33_650M, protbert
Uses 200 samples for evaluation.
"""
...
def main():
    ...
    output_path = Path("./mparsa/bench/procap-v2/benchmark_results/family_results.json")
    num_samples = 200
    models_to_test = ["esm2_t6_8M", "esm2_t33_650M", "protbert"]

    print("=" * 80)
    print("Protein Family Classification Benchmark - Linear Probe Evaluation")
    print("=" * 80)
